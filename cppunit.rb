...
## Copied from HomeBrew's original "cppunit.rb"
## (https://github.com/Homebrew/linuxbrew/blob/linuxbrew/Library/Formula/cppunit.rb)
##
## But added "LDFLAGS=-ldl" to "./configure" inorder to make it compile
## on recent linuxes (see: http://sourceforge.net/p/cppunit/bugs/210/ ).
##
#
